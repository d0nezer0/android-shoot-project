...
/**
 * https://www.cnblogs.com/jeffen/p/6828569.html
 * Log.v() Log.d() Log.i() Log.w() 以及 Log.e()。
 * 根据首字母分别对应VERBOSE,DEBUG,INFO,WARN,ERROR。
 */
public class LogUtilsResourceMonitor {
    ...
    private static String MYLOGFILEName = "shootlog_ResourceMonitor.txt";// 本类输出的日志文件名称
